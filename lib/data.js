...
import {
  ...
  TalaverseImage,
  EmveepImage,
  FiksiIdeaLitmusImage,
  RancanginImage,
  SerampangSendalImage,
  TuyulMantulImage,
  SpyInLifeImage,
  RogueAngelImage,
} from "./images";
...
export const PROJECTS = [
  {
    title: "Talaxeum",
    description:
      "A green DeFi utility token platform designed to support real-world business projects in reducing carbon emissions through utility tokens, stablecoins, and NFTs.",
    image: TalaxImage,
    tags: [
      "Next.js",
      "Tailwind",
  ...
  },
  {
    title: "Talaverse",
    description:
      "A play-to-earn Telegram mini-game within the Talaxeum ecosystem that merges sustainability with gaming, rewarding players with $TALAX tokens and NFTs for eco-friendly missions.",
    image: TalaverseImage,
    tags: [
      "Next.js",
      "Typescript",
      "Tailwind",
    ...
    visit: "https://t.me/talaverse_bot/talaverse?startapp=TALAM0M7U3R",
    status: "active",
    platform: "web",
  },
  {
    title: "Emveep Company Profile",
    description:
      "Company profile for a startup studio specializing in cost-effective MVP development, scalable web/mobile architectures, and IT resource provisioning since 2006.",
    image: EmveepImage,
    tags: [
      "Next.js",
      "CSS",
    ...
    visit: "https://www.emveep.com",
    status: "active",
    platform: "web",
  },
  {
    title: "Fiksi Idea Litmus",
    description:
      "FIKSI Idea Litmus is a no-nonsense validation tool built to filter out the 90% of business ideas that fail. It helps you quickly determine if your concept is part of the winning 1% or just another weak idea that wastes time.",
    image: FiksiIdeaLitmusImage,
    tags: ["React.js", "Javascript", "CSS", "Gemini API"],
    visit: "https://fiksi-idea-litmus.vercel.app/",
    github: "https://github.com/dionovanramadhani/fiksi-idea-litmus",
    status: "active",
    platform: "web",
  },
  {
    title: "Rancangin",
    description:
      "A mind-map-based research tool to transform your brilliant ideas into a systematic, award-ready framework for scientific papers.",
    image: RancanginImage,
    tags: ["HTML", "CSS", "Javascript", "Gemini API"],
    visit: "https://ns-rancangin-beta.vercel.app/",
    github: "https://github.com/dionovanramadhani/ns-rancangin-beta",
    status: "beta",
    platform: "web",
  },
  {
    title: "Talaxeum NFT",
    description:
      "TalaxeumNFT is an ERC-721 smart contract that serves as the core minting and NFT marketplace engine for the Talaxeum ecosystem platform.",
    tags: ["ETH", "BSC", "Solidity", "Ethers.js", "Hardhat"],
    visit: "https://bscscan.com/address/0x6cC9996E6C7eB694c0b5f799A64B5cFeD980ed76",
    status: "mainnet",
  ...
  },
  {
    title: "Talax Split",
    description:
      "An automated revenue-sharing and payment-routing smart contract that securely distributes ERC-20 stablecoin payments (USDT/USDC/BUSD) within the Talaxeum NFT ecosystem.",
    tags: ["ETH", "BSC", "Solidity", "Ethers.js", "Hardhat"],
    visit: "https://bscscan.com/address/0xBA1908C265B5727fB104e2F515a190e056c7673C",
    status: "mainnet",
    platform: "smart contract",
  },
  {
    title: "Talax Vesting",
    description:
      "An automated token vesting and time-lock smart contract that enforces customized release schedules and cliffs to ensure long-term token stability.",
    tags: ["ETH", "BSC", "Solidity", "Ethers.js", "Hardhat"],
    visit:
      "https://sepolia.etherscan.io/address/0x99f44Ce3020F66306E91078a42CCC0Fc4Dcaf132",
    status: "testnet",
    platform: "smart contract",
  },
  {
    title: "Serampang Sandal",
    description: "An endless runner game with serampang sandal concept.",
    image: SerampangSendalImage,
    tags: ["Unity", "C#"],
    visit: "https://cyclonedev.itch.io/serampang-sandal-game",
    github: "https://github.com/dionovanramadhani/serampang-sendal-game",
    status: "launched",
    platform: "game",
  },
  {
    title: "Tuyul Mantul",
    description:
      "An action pinball game blended with RPG progression, where players launch a small ghost named Tuyul to defeat waves of enemies and save the kingdom.",
    image: TuyulMantulImage,
    tags: ["Unity", "C#"],
    visit:
      "https://play.google.com/store/apps/details?id=com.LenteraNusantara.TuyulMantul&pli=1",
    status: "launched",
    platform: "game",
  },
  {
    title: "Spy In Life",
    description:
      "An anti-corruption educational game where players act as state spies investigating corrupt officials, delivering a strong moral message that corrupt acts have consequences.",
    image: SpyInLifeImage,
    tags: ["Unity", "C#"],
    visit: "https://badtze.itch.io/spy-in-life",
    status: "launched",
    github: "https://github.com/dionovanramadhani/spy-in-life",
    platform: "game",
  },
  {
    title: "Rogue Angel",
    description:
      "A game about a betrayed angel and a devil sharing a single body. Players swap personalities and combine unique powers to save Heaven from tyrannical rule.",
    image: RogueAngelImage,
    tags: ["Unity", "C#"],
    visit: "https://s-1-m-p.itch.io/rogue-angel",
    status: "launched",
    platform: "game",
  },
];
...
export const TAG_TONE = {
  ...
  React: "text-accent-blue ring-accent-blue/30",
  "React.js": "text-accent-blue ring-accent-blue/30",
  Typescript: "text-accent-blue ring-accent-blue/30",
  TypeScript: "text-accent-blue ring-accent-blue/30",
  Javascript: "text-accent-yellow ring-accent-yellow/30",
  JavaScript: "text-accent-yellow ring-accent-yellow/30",
  Tailwind: "text-gruv-aqua ring-gruv-aqua/30",
  "Tailwind CSS": "text-gruv-aqua ring-gruv-aqua/30",
  "Node.js": "text-accent-green ring-accent-green/30",
  "Express.js": "text-accent-yellow ring-accent-yellow/30",
  Prisma: "text-gruv-purple ring-gruv-purple/30",
  PostgreSQL: "text-accent-blue ring-accent-blue/30",
  "Telegram SDK": "text-gruv-aqua ring-gruv-aqua/30",
  CSS: "text-gruv-orange ring-gruv-orange/30",
  HTML: "text-gruv-orange ring-gruv-orange/30",
  "Gemini API": "text-accent-yellow ring-accent-yellow/30",
  Solidity: "text-accent-yellow ring-accent-yellow/30",
  "Ethers.js": "text-gruv-orange ring-gruv-orange/30",
  Hardhat: "text-gruv-orange ring-gruv-orange/30",
  ETH: "text-gruv-purple ring-gruv-purple/30",
  BSC: "text-gruv-purple ring-gruv-purple/30",
  Unity: "text-gruv-aqua ring-gruv-aqua/30",
  "C#": "text-gruv-purple ring-gruv-purple/30",
};
...
export const TOOLS = [
  ...
  { name: "CSS", category: "Frontend", simple: "css/1572B6" },
  { name: "HTML", category: "Frontend", simple: "html5/E34F26" },
  { name: "Bootstrap", category: "Frontend", simple: "bootstrap/7952B3" },

  // Backend & DB
  { name: "Node.js", category: "Backend", simple: "nodedotjs" },
  { name: "Express.js", category: "Backend", simple: "express", invert: true },
  { name: "Nest.js", category: "Backend", simple: "nestjs/E0234E" },
  { name: "Prisma", category: "Backend", simple: "prisma", invert: true },
  { name: "EJS", category: "Backend", simple: "ejs/B4CA65" },
  ...
  { name: "UNIX Command", category: "Tools", simple: "gnubash" },
  { name: "Linux", category: "Tools", simple: "linux" },
];
